    ...
    , ui(new Ui::MainWindow)
{
    ...
    words.resize(7);
    {
        QFile file("/home/alexandr/Fundamentals-of-algorithmization-and-programming/353503/Абдулов А.А./LabWork_5/Task_1/Words/eng.txt");
    ...
    {
        QFile file("/home/alexandr/Fundamentals-of-algorithmization-and-programming/353503/Абдулов А.А./LabWork_5/Task_1/Words/ger.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
    ...
    {
        QFile file("/home/alexandr/Fundamentals-of-algorithmization-and-programming/353503/Абдулов А.А./LabWork_5/Task_1/Words/her.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
    ...
    {
        QFile file("/home/alexandr/Fundamentals-of-algorithmization-and-programming/353503/Абдулов А.А./LabWork_5/Task_1/Words/ara.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
    ...
    {
        QFile file("/home/alexandr/Fundamentals-of-algorithmization-and-programming/353503/Абдулов А.А./LabWork_5/Task_1/Words/chn.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
    ...
    {
        QFile file("/home/alexandr/Fundamentals-of-algorithmization-and-programming/353503/Абдулов А.А./LabWork_5/Task_1/Words/bel.txt");
        file.open(QIODevice::ReadOnly | QIODevice::Text);
        QTextStream in(&file);
        while (!in.atEnd()) {
            line = in.readLine();
