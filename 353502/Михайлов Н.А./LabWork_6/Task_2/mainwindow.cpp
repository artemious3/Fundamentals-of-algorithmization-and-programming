...
{
    print("\nМеню\n\n");
    print("1. Работа с перезаписью текста (файл 20.txt)\n");
    print("2. Работа с массивом данных (файл 20_0.txt)\n");
    print("3. Работа со стурктурой Спортсмен (файл 20_1.txt)\n");
    print("4. Работа со стурктурой Спортсмен в бинарном файле (файл 20_1.bin)\n");
    print("5. Работа с дозаписью текста (файл 20_3.txt)\n");
