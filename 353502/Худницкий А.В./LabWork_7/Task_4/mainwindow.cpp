...
void MainWindow::on_pushButton_clicked()
{
    ...
    ui->label_16->setText("result: " + QString::number(result16) + " time: " + QString::number(elapsed16) + " ms");
    ...
    ui->label_64->setText("result: " + QString::number(result64) + " time: " + QString::number(elapsed64) + " ms");
    ...
    ui->label_128->setText("result: " + QString::number(result128) + " time: " + QString::number(elapsed128) + " ms");
    ...
    ui->label_2048->setText("result: " + QString::number(result2048) + " time: " + QString::number(elapsed2048) + " ms");
...
void MainWindow::on_pushButton_2_clicked()
{
    ...
    for (int i = 0; i < 16; ++i) {
        //if (i % 4 == 0)
        table16->insertItem(QRandomGenerator::global()->bounded(1, 200), QRandomGenerator::global()->bounded(1, 200));
    }

    for (int i = 0; i < 64; ++i) {
        if (i % 4 == 0)
        table64->insertItem(QRandomGenerator::global()->bounded(1, 200), QRandomGenerator::global()->bounded(1, 200));
    }

    for (int i = 0; i < 128; ++i) {
        if (i % 4 == 0)
        table128->insertItem(QRandomGenerator::global()->bounded(1, 200), QRandomGenerator::global()->bounded(1, 200));
    }

    for (int i = 0; i < 1024; ++i) {
        if (i % 4 == 0)
        table2048->insertItem(QRandomGenerator::global()->bounded(1, 200), QRandomGenerator::global()->bounded(1, 200));
    }
    display();
}
