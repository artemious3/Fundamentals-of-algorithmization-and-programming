...
template<typename T, typename U>
void Tree<T, U>::symmetricalPrint(Node<T, U> *node, QLineEdit* lineEdit) {
...
template<typename T, typename U>
void Tree<T, U>::reversePrint(Node<T, U> *node, QLineEdit* lineEdit) {
    if(node == nullptr) return;
...
template<typename T, typename U>
void Tree<T, U>::straightPrint(Node<T, U> *node, QLineEdit* lineEdit) {
    if(node == nullptr) return;
    lineEdit->setText(lineEdit->text() + (node->value) + " | ");
